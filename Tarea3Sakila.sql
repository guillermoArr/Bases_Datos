...
-- Qué cliente ha rentado más de nuestra sección de adultos?
/*
 * Pienso en el significado de "rentar más" en el sentido de cantidad de peliculas rentadas, no por la cantidad de cobro generado, sobre todo 
 * porque las peliculas no cuestan lo mismo al rentarlas y eso podría sesgar los datos hacia aquellas que cuestan más sin un fundamento concreto
 */
...
-- Cuál es nuestro revenue por store?
/*
 * Pensé ir un paso mas y buscar responder el revenue por store en cada año, así podemos contabilizar todos los ingresos por su correspondiente
